...
AGENT_URL="http://eladron.e-technik.uni-ulm.de:8081/nexus/service/local/repositories/snapshots/content/de/uniulm/omi/monitoring/monitoring-agent/1.1-SNAPSHOT/monitoring-agent-1.1-20141002.151747-1-jar-with-dependencies.jar"
